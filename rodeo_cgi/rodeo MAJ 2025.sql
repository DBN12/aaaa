...
--
-- Structure de la table `fees_2025`
--

CREATE TABLE `fees_2025` (
...
--
-- Structure de la table `invoices_2025`
--
...
--
-- Structure de la table `reports_2025`
--

CREATE TABLE `reports_2025` (
  `userid` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `workhours_2025`
--

CREATE TABLE `workhours_2025` (
  `week` int(11) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `workhours_2025`
--

INSERT INTO `workhours_2025` (`week`, `freedays`, `hours`, `comment`) VALUES
(1, NULL, 40, NULL),
(2, NULL, 40, NULL),
(3, NULL, 40, NULL),
(4, NULL, 40, NULL),
