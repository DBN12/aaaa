...
--
-- Structure de la table `fees_2020`
--
...
--
-- Structure de la table `invoices_2020`
--

CREATE TABLE `invoices_2020` (
  `projid` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `reports_2020`
--

CREATE TABLE `reports_2020` (
  `userid` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `workhours_2020`
--

CREATE TABLE `workhours_2020` (
  `week` int(11) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `workhours_2020`
--

INSERT INTO `workhours_2020` (`week`, `freedays`, `hours`, `comment`) VALUES
