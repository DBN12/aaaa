...
--
-- Structure de la table `fees_2023`
--

CREATE TABLE `fees_2023` (
...
--
-- Structure de la table `invoices_2023`
--

CREATE TABLE `invoices_2023` (
  `projid` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `reports_2023`
--
...
--
-- Structure de la table `workhours_2023`
--

CREATE TABLE `workhours_2023` (
  `week` int(11) NOT NULL DEFAULT '0',
...
--
-- Contenu de la table `workhours_2023`
--

INSERT INTO `workhours_2023` (`week`, `freedays`, `hours`, `comment`) VALUES
(1, NULL, 40, NULL),
(2, NULL, 40, NULL),
(3, NULL, 40, NULL),
(4, NULL, 40, NULL),
