...
//				echo "semaine_min:$semaine_min/$an_periode - semaine_max:$semaine_max/$an_periode<br />";
// MODIF 20241224
...
//				}
				if ($semaine_max == 1 && $semaine_max <$semaine_min) {
					$semaine_max = 53;
//					$a_cheval = true;
					$a_cheval = true;	// remis le 24/12/2024
				}
// FIN MODIF 20200114
// MODIF 20200114
//	 			Ou en semaine 53
...
//				Détecter les semaine à cheval sur 2 mois et les exclure	
...
//					echo "ligneWeek=".$ligne["week"]." jour_semaine_deb=$jour_semaine_deb jour_semaine_fin=$jour_semaine_fin i_min=$i_min i_max=$i_max<br />";
